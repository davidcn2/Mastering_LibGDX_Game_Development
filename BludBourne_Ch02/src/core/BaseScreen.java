...

{
    ...
    */
    ...
    protected BaseGame game; // Reference to extended game class.
    ...
    // g = Reference to extended game class.
    ...
    public BaseScreen(BaseGame g, int windowWidth, int windowHeight)
    {
        ...
        // 2.  Stores reference to extended Game object.
        ...
        // Store reference to extended Game object.
        this.game = g;
    ...
    */
    ...
    public void hide()    
    {
        // The method gets called when the screen becomes the previous one for a Game.
    }
